...
import 'package:fnv/admin/admin_main_screen.dart';
  ...
  Future<void> signIn() async {
    ...
    if (user != null) {
      ...
      Future.delayed(const Duration(seconds: 1), () {
        ...
        if (user.level == 1) {
          destinationScreen = AdminMainScreen();
        } else {
          destinationScreen = MainScreen();
        }
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                Image.asset(
                  'assets/image-gen-removebg-preview.png',
                  height: 160,
                ),
                            ...
                            text: TextSpan(
                              children: <TextSpan>[
                                TextSpan(
                                  ...
                                  style: const TextStyle(
                                    color: Color.fromARGB(255, 83, 115, 255),
                                    decoration: TextDecoration.underline,
                                  ),
                                  recognizer: TapGestureRecognizer()
                                    ..onTap = () {
